...
console.log(solution_4([-6, -3, -2, -1, 0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 17, 18, 19, 20]),
    "/ -6,-3-1,3-5,7-11,14,15,17-20");

console.log(solution_4([-10, -9, -8, -6, -3, -2, -1, 0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 17, 18, 19, 20]),
    "/ -10--8,-6,-3-1,3-5,7-11,14,15,17-20");


solution_5 = list =>
    list.map((item, i, arr) => (item - 1 === arr[i - 1] && item + 1 === arr[i + 1] ? "-" : item))
        .map((item, i, arr) => (item !== arr[i + 1] ? item : "@"))
        .filter(a => a !== "@")
        .join(",")
        .replace(/(,-,)/g, "-");

console.log(solution_5([-6, -3, -2, -1, 0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 17, 18, 19, 20]),
    "/ -6,-3-1,3-5,7-11,14,15,17-20");
